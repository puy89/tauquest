        ...
        self._lexicon = \
            {
                ...
                'course': ['lec_courses', 'cou_lecturers', 'rev_mul_department', 'rev_mul_faculty', 'mul_multi_course_id'],
                'name': ['mul_name', 'lec_name'],
                'taught': ['lec_courses'],
                'lecturer': ['cou_lecturers', 'lec_courses'],
                'teacher': ['cou_lecturers'],
                'staff': ['cou_lecturers'],
                'department': ['mul_department', 'mul_faculty'],
                'faculty': ['mul_faculty', 'mul_department'],
                'when': ['occ_day', 'occ_start_time', 'mul_semester'],# add full timea
                'i': [],
                'take': [],
                'it': [],
                'what': [],
                ...
                'semester': ['mul_semester'],
                'kind': ['cou_kind'],
                'honor': ['lec_honor'],
                'title': ['lec_honor'],
                'end': ['occ_full_end_time', 'occ_end_time'],
                'till': ['occ_full_end_time', 'occ_end_time'],
                'until': ['occ_full_end_time', 'occ_end_time'],
                ...
                'first': [Entity(1, 'semester')],
                'winter': [Entity(1, 'semester')],
                'second': [Entity(2, 'semester')],
                'spring': [Entity(2, 'semester')],
                'collide': ['intersect'],
